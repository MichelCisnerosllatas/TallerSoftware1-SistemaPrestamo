...
<body>
    <nav class="menu_navegacion" id="nav">
        <ul>
            ...
            @if(session("usuariologin")["IdRol"] === "3" || session("usuariologin")["IdRol"] === "2")
                <li>
            ...
            @if(session("usuariologin")["IdRol"] === "4" || session("usuariologin")["IdRol"] === "2" || session("usuariologin")["IdRol"] === "1")
                <li>
...
{{--                </li>--}}
            ...
            @if(session('usuariologin')['IdRol'] === '2' || session('usuariologin')['IdRol'] === '1' || session('usuariologin')['IdRol'] === '3')
                <li>
...
{{--                    <a href="/Ajustes">Configuración</a>--}}
        ...
        <div class="div_contenedor">
            @yield('content')  <!-- Aquí se inyecta el contenido de las vistas hijas -->
        </div>
    </main>
    ...
    @stack('scripts')  <!-- Esto es importante para que los scripts de las vistas hijas se agreguen al final del body -->
</body>
</html>
