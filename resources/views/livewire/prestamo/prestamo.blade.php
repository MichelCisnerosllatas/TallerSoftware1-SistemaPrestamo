<div>
    <div id="div_text_tituloPrestamo" class="div_text_tituloPrestamo">
        ...
        <label>Total: {{ $totalRegistrosPrestamo }}, paginas: {{ $totalPaginasPrestamo }} </label>
                        ...
                        <td>
                            <div class="prestamo-detalles">
                                <div class="prestamo-columna">
                                    ...
                                    <span class="prestamo-valor">S/. {{ $Prestamo['MontoPrestado'] }}</span>
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Interés:</span>
                                    <span class="prestamo-valor">{{ $Prestamo['PorcentajeInteres'] }}%</span>
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Devolución:</span>
                                    <span class="prestamo-valor">{{ $Prestamo['MontoDevolucion'] }}</span>
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Monto Interés:</span>
                                    <span class="prestamo-valor">S/. {{ $Prestamo['MontoInteres'] }}</span> <!-- Valor por defecto -->
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Monto Cuota:</span>
                                    <span class="prestamo-valor">S/. {{ $Prestamo['MontoCuota'] }}</span> <!-- Valor por defecto -->
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Cuotas Total:</span>
                                    <span class="prestamo-valor">{{ $Prestamo['Cuotas'] }}</span> <!-- Valor por defecto -->
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Cuotas Pagadas:</span>
                                    <span class="prestamo-valor">{{ $Prestamo['CuotasPagadas'] }}</span> <!-- Valor por defecto -->
                                </div>
                                <div class="prestamo-columna">
                                    <span class="prestamo-clave">Restante:</span>
                                    <span class="prestamo-valor">S/. {{ $Prestamo['MontoRestante'] }}</span> <!-- Valor por defecto -->
                                </div>
                                <div class="prestamo-columna">
                                    ...
                                    <span class="prestamo-valor" style="
                                        @if($Prestamo['Estado'] == 'Completado')
                                            color: green;
                                        @elseif($Prestamo['Estado'] == 'Eliminado')
                        ...
                        <td>
                            <div class="fecha-registro">
                                <div class="fecha-clave">
                                    <span>Fecha: </span>
                                    <span class="prestamo-valor">{{ $Prestamo['FechaRegistro'] }}</span>
                                </div>
                                <div class="hora-clave">
                                    <span>Hora: </span>
                                    <span class="prestamo-valor">{{ $Prestamo['HoraRegistro'] }}</span>
                                </div>
                            </div>
                        </td>
                        <td class="accion-btn">
                            <button id="btnOpcionesPrestamo" class="buttonPrincipal2"
                                    ...
                                    data-index="{{ $index }}" style="min-width: 30px;">
