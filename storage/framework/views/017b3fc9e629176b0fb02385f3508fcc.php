<div class="div_clientelivewire">
    <div class="div_text_titulocliente">
        <div>
            <button id="botonNuevoCliente" class="buttonPrincipal2">Nuevo Cliente</button>
            ...
            <label>Total <?php echo e($totalRegistros); ?> Clientes en <?php echo e($totalPagina); ?> paginas</label>
        </div>

        <div>
            <label>Fila:</label>
            <select id="selectClienteFilas" class="select" style="min-width: 60px;">
            ...
            <h3><?php echo e($paginaCliente); ?></h3>
    ...
    <!--[if BLOCK]><![endif]--><?php if(count($clientes) > 0): ?>
        <div class="divtablacliente">
            <table>
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($cliente['FechaRegistro']); ?></td>
                            <td class="">
                                <button id="btnEditarCliente" class="btneditarCliente"
                                        data-cliente="<?php echo e(json_encode($cliente)); ?>"
...
<?php /**PATH C:\laragon\www\SistemaPrestamo\resources\views/livewire/cliente/cliente.blade.php ENDPATH**/ ?>