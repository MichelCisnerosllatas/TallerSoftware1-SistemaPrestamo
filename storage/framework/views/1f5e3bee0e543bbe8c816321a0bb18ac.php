...
[$__name, $__params] = $__split('prestamo.prestamo');

$__html = app('livewire')->mount($__name, $__params, 'lw-2341859015-0', $__slots ?? [], get_defined_vars());
    ...
    <div id="ventana-content-NuevoPrestamo" class="ventana-content-NuevoPrestamo">
        ...
        <div class="ventanaPrestamoHeader">
            <div style="display: flex;">
                ...
                <h2 id="ventanaTitlePrestamoMant" class="ventana-title" style="padding: 0 10px;">Nuevo Prestamo</h2>
            </div>


            <button id="btnagregarpagoprestamodetalleMant" type="button" class="buttonPrincipal2" style="min-height: 30px;">Nuevo Pago</button>
        </div>

        <div class="ventana-form-container">
            <div id="cardprestamomant" class="container">
                <form>
                    <div class="divprestamoaleatorios">
                        ...
                        <div class="divlabelsPrestamos" style="display: flex">
                            ...
                            <input type="hidden" id="inputPrestamoSeleccionarClienteIDCliente" disabled required style="width: 40px;">
                            <input type="text" id="inputPrestamoSeleccionarCliente" placeholder="Seleccione un Cliente" disabled required>
                    ...
                    <div class="divprestamoaleatorios" style="display: none">
                        <div class="divlabelsValoresPrestamos">
                    ...
                    <div class="divprestamoaleatorios">
                        ...
                        <div class="divlabelsPrestamos">
                            <input type="text" pattern="^\d+(\.\d{1,2})?$" id="inputMontoPrestamo" placeholder="0.00" style="font-size: 18px; font-weight: bold;">
                            <label id="labelerrorprestamoinputMontoPrestamo" style="color: var(--color-rojo)">Parametro Erroneo</label>
                        </div>
                    </div>
            ...
            <div id="cardprestamoresultadomant" class="container">
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <label id="labelValorFechaVencimientoPrestamo" style="display: none; font-weight: bold;">No Definido</label>
                    <label id="labelValorFechaVencimientoPrestamoVISTA" style="font-weight: bold;">No Definido</label>
                </div>
            ...
            <div id="cardprestamodetalle1" class="container">
                <?php echo $__env->make('Prestamos.detalleprestamo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div id="cardprestamodetalle2" class="container" style="padding: 0;">
                <?php echo $__env->make('circuleprogressindicator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('pagos.tablapagosprestamo');

$__html = app('livewire')->mount($__name, $__params, 'lw-2341859015-1', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div id="ventanaPrestamoFooter" class="ventanaPrestamoFooter">
...
[$__name, $__params] = $__split('cliente.seleccionar-cliente');

$__html = app('livewire')->mount($__name, $__params, 'lw-2341859015-2', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <?php echo $__env->make("Prestamos.nuevopagoprestamo", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>


<!-- Menú contextual del Clik derecho en la tabla Prestamo-->
<div id="idmenuopcionesprestamo" class="menuopcionesprestamo">
    <label id="idlabeldetalleprestamo" data-index="<?php echo e($index ?? 0); ?>">Detalle</label>
    <label id="idlabeleditarprestamo" data-index="<?php echo e($index ?? 0); ?>">Editar</label>
    <label id="idlabeleliminarprestamo" data-index="<?php echo e($index ?? 0); ?>">Eliminar</label>
    <label style="display: none;" id="idlabelactivarprestamo" data-index="<?php echo e($index ?? 0); ?>">Activar</label>
    <label style="display: none;" id="idlabeldesactivarprestamo" data-index="<?php echo e($index ?? 0); ?>">Desactivar</label>
    <label id="idlabelAgregarPagoprestamo" data-index="<?php echo e($index ?? 0); ?>">Agregar un pago</label>
</div>



<?php /**PATH C:\laragon\www\SistemaPrestamo\resources\views/Prestamos/index.blade.php ENDPATH**/ ?>