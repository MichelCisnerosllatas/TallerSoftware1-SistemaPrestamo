<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(count($datosClientesPrestamos) > 0): ?>
        <div class="div_text_titulocliente">
            <div>
                ...
                <label>Total clientes: <?php echo e($totalClientes); ?></label>
            </div>
        </div>
        <div class="divtablaSelecionarCliente">
            <table>
                ...
                <tbody>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $datosClientesPrestamos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="">
                            <button id="btnseleccionarcliente" class="buttonPrincipal1"
                                    ...
                                    data-index="<?php echo e($index); ?>">Seleccionar
                            </button>
                        </td>
                    </tr>
...
<?php /**PATH C:\laragon\www\SistemaPrestamo\resources\views/livewire/cliente/seleccionar-cliente.blade.php ENDPATH**/ ?>