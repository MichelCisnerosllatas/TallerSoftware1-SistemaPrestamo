...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')([
        ...
        'resources/css/Clientes/styleClientesReciclaje.css',
        ...
        'resources/css/Prestamos/stylePrestamoReciclaje.css',
        ...
        'resources/js/Clientes/appClientesReciclaje.js',
        ...
        'resources/js/Prestamos/appPrestamoReciclaje.js',
        ...
        'resources/js/Reciclaje/appReciclaje.js',
    ...
    <link rel="stylesheet" href="<?php echo e(asset('apexcharts/dist/apexcharts.css')); ?>">
    <script src="<?php echo e(asset("apexcharts/dist/apexcharts.js")); ?>"></script>
</head>
<body>
    <nav class="menu_navegacion" id="nav">
        <ul>
            ...
            <br>
            <br>
            <h5 style="color: var(--color-blanco)">Menu</h5>
            <br>

            <?php if(session("usuariologin")["IdRol"] === "3" || session("usuariologin")["IdRol"] === "2"): ?>
                <li>
                    <a id="enlaceDashboard" href="/Dashboard" title="Inicio">
                        <svg style="pointer-events: none;" xmlns="http://www.w3.org/2000/svg" height="24" width="22.5" viewBox="0 0 576 512"><path fill="#fcfcfd" d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
                        <span style="pointer-events: none;">Inicio</span>
                    </a>
                </li>
            <?php endif; ?>
            <li>
            ...
            <?php if(session("usuariologin")["IdRol"] === "4" || session("usuariologin")["IdRol"] === "2" || session("usuariologin")["IdRol"] === "1"): ?>
                <li>
            ...
            <?php if(session('usuariologin')['IdRol'] === '2' || session('usuariologin')['IdRol'] === '1' || session('usuariologin')['IdRol'] === '3'): ?>
                <li>
            ...
            <?php if(session('usuariologin')['IdRol'] === '2' || session('usuariologin')['IdRol'] === '3'): ?>
                <h5 style="color: var(--color-celeste-claro-2)">Administracion</h5>
                <hr>
                <br>
                ...
                <li>
                    <a href="/Reciclaje" title="Reciclaje">
    ...
    <main>
        <header class="menu_cabezera">
            ...
            <div class="dropdown">
                <button class="dropbtn">Hola, <?php echo e(session('usuariologin')['Nombre'] ?? 'Error'); ?></button>
            ...
            <!-- Formulario oculto para la petición de cierre de sesión -->
        ...
        <div class="div_contenedor">
            <?php echo $__env->yieldContent('content'); ?>  <!-- Aquí se inyecta el contenido de las vistas hijas -->
        </div>
    </main>
    ...
    <script>
        ...
        // Escuchar el evento SweetProgressOpen de Livewire
        Livewire.on('SweetProgressOpen2', function (data) {
            const event = data[0];
            Swal.fire({
                title: event.title,
                text: event.text,
        ...
        // Escuchar el evento para cerrar el modal de carga
        Livewire.on('SweetProgressClose2', function () {
            Swal.close();  // Cierra el modal de carga
        });

        // Escuchar el evento SweetAlertPrincipal de Livewire para mostrar el modal de éxito/error
    ...
    <?php echo $__env->yieldPushContent('scripts'); ?>  <!-- Esto es importante para que los scripts de las vistas hijas se agreguen al final del body -->
</body>
</html>
<?php /**PATH C:\laragon\www\SistemaPrestamo\resources\views/principal.blade.php ENDPATH**/ ?>